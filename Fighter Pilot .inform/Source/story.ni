...
Wash room is a room. It is west of the Hallway. The shower is a device in the Wash room. 

Taking is an action applying to one visible thing. 
Understand "take [shower]" or "turn on [shower]" as taking 
Instead of taking shower:
	say "You turn on the shower and let it run for a bit to warm up. Once it is warm you jump in and take a quick shower to clean yourself up.";
	Player is now clean. 

The player can be clean or dirty. 
...
Understand "ask [Jackson] about key" or “ask [Jackson] about equipment room key” or "ask [Jackson] for key" as asking.
